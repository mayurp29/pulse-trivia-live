...
drop policy if exists "anon can read quiz templates" on public.quiz_templates;
drop policy if exists "anon can write quiz templates" on public.quiz_templates;
...
create policy "anon can read quiz templates"
on public.quiz_templates for select
to anon
using (true);

create policy "anon can write quiz templates"
